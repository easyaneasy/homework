...
async function getSingleCartFirstProduct(){
    const cart = await axios.get("https://dummyjson.com/carts/1");
    const cartData = cart.data;
    const firstId = cartData.products[0].id;
    
    const product = await axios.get(`https://dummyjson.com/products/${firstId}`);
