...
async function getTopRatedMoviesResponse(){
    const API_URL = "https://api.themoviedb.org/3/movie/top_rated?language=ko-KR";
    const config = {
        method: 'GET',
        headers: {
...
async function getSingleMovieResponse(){
    const API_URL = "https://api.themoviedb.org/3/movie/22?language=ko-KR";
    const config = {
        method: 'GET',
        headers: {
          accept: 'application/json',
...
async function getNowPlayingTopMoviesResponse(){
    const API_URL = "https://api.themoviedb.org/3/movie/now_playing?language=ko-KR";
    const config = {
        method: 'GET',
        headers: {
          accept: 'application/json',
    ...
    const topRatedMovie = movies.reduce((max, current) => {
